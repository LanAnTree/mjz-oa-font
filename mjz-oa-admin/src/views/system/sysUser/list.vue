<template>
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="关 键 字">
              <el-input style="width: 95%" v-model="searchObj.keyword" placeholder="用户名/姓名/手机号码"  @keyup.enter.native="fetchData()"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
    ...
    <!-- 工具条 -->
    <div class="tools-div" style="margin: 15px 0;">
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%" >
      <el-form ref="dataForm" :model="sysUser"  label-width="100px" size="small" style="padding-right: 40px;">
        ...
        <el-form-item label="手机" prop="phone">
          <el-input v-model="sysUser.phone"  @keyup.enter.native="saveOrUpdate()" />
        </el-form-item>
      </el-form>
