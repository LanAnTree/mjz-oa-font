        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="角色名称">
              <el-input style="width: 100%" v-model="searchObj.roleName" placeholder="角色名称" @keyup.enter.native="fetchData()"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%" >
      <el-form ref="dataForm" :model="sysRole" label-width="150px" size="small" style="padding-right: 40px;">
        ...
        <el-form-item label="角色编码">
          <el-input v-model="sysRole.roleCode" @keyup.enter.native="saveOrUpdate()" />
        </el-form-item>
      </el-form>
